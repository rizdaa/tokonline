<?php
    ...
    $product = query("SELECT * FROM product where id_rental = $id_rental;");
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <a href="ubah.php?id_mobil=<?= $data['id_mobil'] ?>" class="btn btn-primary " style="margin-right: 5px;">Ubah</a>
                                                
                                                    <a href="hapus.php?id_mobil=<?= $data['id_mobil'] ?>"  class="btn btn-danger ">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                                            <?php endforeach; ?>
